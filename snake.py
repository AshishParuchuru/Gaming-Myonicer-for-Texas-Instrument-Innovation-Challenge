...
pygame.init();s=pygame.display.set_mode((600, 600));pygame.display.set_caption('Snake');appleimage = pygame.Surface((10, 10));
appleimage.fill((0, 255, 255));img = pygame.Surface((20, 20));img.fill((255, 255, 0));f = pygame.font.SysFont('Arial', 20);clock = pygame.time.Clock()
while True:
	clock.tick(10)
	for e in pygame.event.get():
		if e.type == QUIT:
			...
			elif e.key == K_RIGHT and dirs != 3:dirs = 1;appleimage.fill((0,255,200))
	i = len(xs)-1
	while i >= 2:
